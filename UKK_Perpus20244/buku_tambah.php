       ...
       <form method="post">
            ...
            <?php 
                if(isset($_POST['submit'])){
                    ...
                    $stok = $_POST['stok'];
                    $query = mysqli_query($koneksi, "INSERT INTO buku(id_kategori,judul,foto,penulis,penerbit,tahun_terbit,deskripsi,stok) values ('$id_kategori','$judul','$foto','$penulis','$penerbit','$tahun_terbit','$deskripsi','$stok')");
