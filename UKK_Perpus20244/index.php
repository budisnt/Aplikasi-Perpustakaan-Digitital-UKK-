...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <img alignimg class="img-profile rounded- circle" src="assets/img/yy.PNG" width="80px" height="55px"></a>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="sb-sidenav-menu-heading">Data Perpustakaan</div>
                            <?php
                            ...
                            ?>
                             <a class="nav-link" href="register_petugas.php">
